...
System System( /CELL/CYTOPLASM )
{
	...
	Variable Variable( PnCube )
	{
		Value	@(6.21367E-01 * 6.21367E-01 * 6.21367E-01);
	}

	Process ExpressionAssignmentProcess( PnCube )
	{
		Expression "C0.Value * C0.Value * C0.Value";

		VariableReferenceList	[ P0 Variable:.:PnCube 1 ] [ C0 Variable:.:Pn 0 ];
	}
	...
	Process ExpressionFluxProcess( R_toy1 )
	{
		...
		Expression "( (vs*KI) / (KI + C0.Value ) * self.getSuperSystem().SizeN_A )";

		VariableReferenceList	[ P0 Variable:.:M 1 ] [ C0 Variable:.:PnCube ];
	}
