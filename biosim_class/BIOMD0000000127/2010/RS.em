...
#     Process ExpressionAssignmentProcess(v_sw)
#     {
#		StepperID    PSV;
#
#	        VariableReferenceList
...
#                c_sw -65;
#
#		Expression "geq(v.Value, v_lm)*c_sw+lt(v.Value, v_lm)*v.Value";
#     }
...
#     Process ExpressionAssignmentProcess(u_sw)
#     {
#		StepperID    PSV;
#
#	        VariableReferenceList
...
#                d_sw 8.0;
#
#		Expression "geq(v.Value, v_lm)*(u.Value+d_sw)+lt(v.Value, v_lm)*u.Value";
#     }
}
