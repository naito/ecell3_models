...
LIBECS_DM_CLASS( CytoplasmAlgebraicProcess, SpyContinuousProcess )
{
 ...
 public:
	...
	virtual void initialize()
	{
		...
		// ODE // totalIonex  = getVariableReference( "totalIonex" ).getVariable();
...
//		Vt->setValue( _Vt );
		...
		//WaterFlux->setValue( f * Cm->getValue() * ( _totalIonin / _SizeN_A - getPropertyValue( totalIonexFullPN ) ) );
